...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="text-2xl font-bold leading-tight text-gray-900">⭐ Starred Files</h2>
    </template>
    ...
    <div class="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div v-if="filtered.length === 0" class="bg-white shadow rounded-lg p-12 text-center">
        ...
        <p class="text-gray-600 font-medium">No starred files yet</p>
        <p class="text-gray-500 text-sm mt-2">Star your favorite files to see them here</p>
      </div>
